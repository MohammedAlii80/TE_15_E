...
tour.register('test_delivery_lot_with_package_delivery_step', {test: true}, [
    {
        trigger: '.o_barcode_line',
        run: 'scan sn'
    },
...
tour.register('test_same_barcode_multi_company', {test: true},[
    {
        trigger: '.o_stock_barcode_main_menu',
        run: 'scan 1234567',
    },
    ...
    {
        trigger: '.o_current_location',
        run: function() {
            helper.assertPageSummary('From copma/Stock/locationB To copma/Stock');
        }
    }
]);
});
